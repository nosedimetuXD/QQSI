// Global Questions Bank for QQSI
  ...
  "rounds": [
    {
      ...
      "name": "Nivel Fácil",
      "timeLimit": 120,
      "description": "Tiempo por pregunta: 2:00 minutos. 5 Equipos en competencia.",
      "questions": [
        {
          "id": "f-1",
          "number": 1,
          "title": "Pregunta 1",
          "type": "math",
          "statement": "Resolver la siguiente ecuación:",
          "math": "e^{\\ln(x^2)} = 5x + 6",
          "answerGuide": "x^2 - 5x - 6 = 0 \\implies (x - 6)(x + 1) = 0 \\implies x_1 = 6,\\; x_2 = -1 (ambas soluciones válidas ya que x^2 > 0)."
        },
        {
          "id": "f-2",
          "number": 2,
          "title": "Pregunta 2",
          "type": "math",
          "statement": "Derive la siguiente función:",
          "math": "y = \\arctan(x)",
          "answerGuide": "y' = \\frac{1}{1 + x^2}"
        },
        {
          "id": "f-3",
          "number": 3,
        ...
        },
        {
          ...
          "statement": "¿Cuál de los siguientes elementos o sustancias es considerado un contaminante común de los cuerpos de agua?",
          "options": [
            "A) Oxígeno Disuelto Puro",
            "B) Agua de lluvia natural",
            "C) Sales minerales inofensivas",
            "D) Plástico de un solo uso"
          ],
          "answerGuide": "Opción D: Plástico de un solo uso."
        },
        {
          "id": "f-5",
          "number": 5,
        ...
        },
        {
          ...
          "title": "Pregunta 7",
          "type": "text",
          "statement": "¿Qué ley de la física establece que «con toda acción ocurre siempre una reacción igual y contraria»?",
          "answerGuide": "Tercera Ley de Newton (Ley de Acción y Reacción)."
        },
        {
          "id": "f-8",
          "number": 8,
        ...
        },
        {
          ...
          "title": "Pregunta 9",
          "type": "text",
          "statement": "¿Cómo se denomina genéricamente a una estructura de control iterativa que permite repetir un bloque de instrucciones de manera automatizada?",
          "answerGuide": "Bucle / Ciclo (Loop) — for, while, do-while."
        },
        {
          "id": "f-10",
          "number": 10,
    ...
    },
    {
      ...
      "name": "Nivel Normal",
      "timeLimit": 180,
      "description": "Tiempo por pregunta: 3:00 minutos. 4 Equipos en competencia.",
      "questions": [
        {
          "id": "n-1",
          "number": 1,
        ...
        },
        {
          ...
          "title": "Pregunta 4",
          "type": "text",
          "statement": "En un control de calidad se analizan 5 muestras con los siguientes valores numéricos: 10, 12, 10, 14, 19. ¿Cuál es la mediana de este conjunto de datos?",
          "answerGuide": "Ordenados: [10, 10, 12, 14, 19]. La mediana (valor central) es 12."
        },
        {
          "id": "n-5",
          "number": 5,
        ...
        },
        {
          ...
          "title": "Pregunta 6",
          "type": "text",
          "statement": "¿Cuánto trabajo mecánico en Joules realiza una fuerza constante de 15 N al desplazar un objeto a lo largo de una línea recta una distancia de 4 metros en la misma dirección de la fuerza?",
          "answerGuide": "W = F · d = 15 N · 4 m = 60 Joules (J)."
        },
        {
          "id": "n-7",
          "number": 7,
    ...
    },
    {
      ...
      "name": "Nivel Difícil",
      "timeLimit": 360,
      "description": "Tiempo por pregunta: 6:00 minutos. 3 Equipos en competencia.",
      "questions": [
        {
          "id": "d-1",
          "number": 1,
        ...
        },
        {
          ...
          "title": "Pregunta 3",
          "type": "math",
          "statement": "Una planta industrial busca optimizar sus costos en reactivos químicos. Si la función de costos totales está modelada por la ecuación cuadrática:\n$$C(x) = x^2 - 8x + 30$$\nDonde $x$ representa el número de lotes producidos. ¿Cuántos lotes se deben procesar para minimizar el costo total, y cuál es el valor de ese costo mínimo?",
          "answerGuide": "Vértice: x = -b/(2a) = 8/(2) = 4 lotes. Costo mínimo: C(4) = 4^2 - 8(4) + 30 = 16 - 32 + 30 = 14 unidades monetarias."
        },
        {
          "id": "d-4",
          "number": 4,
    ...
    },
    {
      ...
      "name": "Nivel Experto",
      "timeLimit": 480,
      "description": "Tiempo por pregunta: 8:00 minutos. ¡Gran Final entre 2 Equipos!",
      "questions": [
        {
          "id": "e-1",
          "number": 1,
